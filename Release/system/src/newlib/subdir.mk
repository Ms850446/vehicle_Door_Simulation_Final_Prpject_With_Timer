...
system/src/newlib/startup.o: ../system/src/newlib/startup.c system/src/newlib/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: GNU Arm Cross C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra -g -DNDEBUG -DSTM32F401xE -DUSE_HAL_DRIVER -DHSE_VALUE=8000000 -DOS_INCLUDE_STARTUP_INIT_MULTIPLE_RAM_SECTIONS -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"C:\Users\HP.SXM10\eclipse-workspace\Embedded-Arm\final_project\Lib" -I"C:\Users\HP.SXM10\eclipse-workspace\Embedded-Arm\final_project\Rcc" -I"C:\Users\HP.SXM10\eclipse-workspace\Embedded-Arm\final_project\Gpio" -I"C:\Users\HP.SXM10\eclipse-workspace\Embedded-Arm\final_project\EXTI" -I"C:\Users\HP.SXM10\eclipse-workspace\Embedded-Arm\final_project\GPT" -I"C:\Users\HP.SXM10\eclipse-workspace\Embedded-Arm\final_project\doorFunctions" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
